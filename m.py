...
bot = telebot.TeleBot('7389804202:AAFDXCJgTFj6AwiUoZs8Y1UJRWD8gLh_lq8')
    ...
    if user_id in admin_id:
        ...
        if len(command) > 2:
            ...
            if user_to_add not in allowed_user_ids:
                ...
                response = "This User Already Exists BC...!!!"
        else:
            response = "Please specify a user ID and the duration (e.g., 1hour, 2days, 3weeks, 4months) to approve...!!!"
    else:
        response = "You have'nt purchased premium plan yet purchase it through venom...!!!"
...
You have'nt purchased premium plan yet purchase it through venom...!!!
'''
